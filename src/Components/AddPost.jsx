export default function AddPost() {
  return (
    <form className="grid grid-cols-2 items-center justify-center justify-items-center gap-2 bg-red-100 py-3 dark:bg-slate-800 sm:flex">
      <input
        type="text"
      ...
      <textarea
        ...
        className="max-h-32 min-h-10 w-max rounded-lg border-orange-400 py-2 pl-2 text-sm shadow-md focus:outline-cyan-500 dark:bg-slate-600 dark:text-slate-300 dark:outline-none sm:min-h-14 sm:w-80 sm:py-4 sm:text-sm md:w-[28rem] xl:w-[46rem]"
      />
