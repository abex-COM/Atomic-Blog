export default function Main({ posts }) {
  if (posts)
    return (
      <div className="overflow-auto dark:bg-slate-900 flex justify-center">
        {posts.length?<ul className="grid w-full grid-cols-2 gap-2 p-2 text-xs xs:grid-cols-2 xs:text-base sm:grid-cols-3 md:grid-cols-4 md:text-lg lg:grid-cols-5 lg:text-xl xl:grid-cols-6">
